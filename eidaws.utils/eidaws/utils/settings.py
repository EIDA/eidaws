...
EIDAWS_STATIONLITE_MAJORVERSION = "1"
EIDAWS_STATIONLITE_PATH = "/".join(
    ["/eidaws/stationlite", EIDAWS_STATIONLITE_MAJORVERSION]
)
EIDAWS_STATIONLITE_PATH_QUERY = "/".join(
    [EIDAWS_STATIONLITE_PATH, FDSNWS_QUERY_METHOD_TOKEN]
)

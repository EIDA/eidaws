...
from eidaws.federator.fdsnws_availability.request import create_app, SERVICE_ID
from eidaws.federator.fdsnws_availability.request.app import DEFAULT_CONFIG
from eidaws.federator.fdsnws_availability.request.route import (
...
from eidaws.federator.utils.pytest_plugin import (
    fdsnws_availability_request_content_type,
...
fdsnws_availability_content_type = fdsnws_availability_request_content_type
...
class TestFDSNAvailabilityQueryServer(
    ...
    FED_PATH_RESOURCE = FED_AVAILABILITY_REQUEST_PATH_QUERY
...
class TestFDSNAvailabilityExtentServer(
    ...
    FED_PATH_RESOURCE = FED_AVAILABILITY_REQUEST_PATH_EXTENT

...
from eidaws.federator.fdsnws_availability.json.view import (
    AvailabilityQueryView,
    AvailabilityExtentView,
)
from eidaws.federator.settings import FED_STATIC, FED_AVAILABILITY_PATH_JSON
...
FED_AVAILABILITY_JSON_PATH_QUERY = (
    FED_AVAILABILITY_PATH_JSON + "/" + FDSNWS_QUERY_METHOD_TOKEN
)
FED_AVAILABILITY_JSON_PATH_EXTENT = (
    FED_AVAILABILITY_PATH_JSON + "/" + FDSNWS_EXTENT_METHOD_TOKEN
)

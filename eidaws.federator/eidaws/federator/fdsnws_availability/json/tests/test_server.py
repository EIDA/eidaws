...
from eidaws.federator.fdsnws_availability.json import create_app, SERVICE_ID
from eidaws.federator.fdsnws_availability.json.app import DEFAULT_CONFIG
from eidaws.federator.fdsnws_availability.json.route import (
    FED_AVAILABILITY_JSON_PATH_EXTENT,
    FED_AVAILABILITY_JSON_PATH_QUERY,
)
...
from eidaws.federator.utils.pytest_plugin import (
    fdsnws_availability_json_content_type,
...
fdsnws_availability_content_type = fdsnws_availability_json_content_type
...
@pytest.fixture
def content_tester(json_schema, load_data):
...
class TestFDSNAvailabilityQueryServer(
    ...
    FED_PATH_RESOURCE = FED_AVAILABILITY_JSON_PATH_QUERY
...
class TestFDSNAvailabilityExtentServer(
    ...
    FED_PATH_RESOURCE = FED_AVAILABILITY_JSON_PATH_EXTENT
